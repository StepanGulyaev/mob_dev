package com.mirea.gulyaevstepanalekseevich.sharer;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent_send.setType("*/*");
        intent_send.putExtra(Intent.EXTRA_TEXT, "Mirea");
        startActivity(Intent.createChooser(intent_send, "It's up for you to choose!"));
        ...
        ActivityResultLauncher<Intent> imageActivityResultLauncher =
                registerForActivityResult(
                        ...
                        callback);
        imageActivityResultLauncher.launch(intent_pick);
    }
}